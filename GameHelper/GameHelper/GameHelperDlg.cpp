// GameHelperDlg.cpp : implementation file
//
...
CGameHelperDlg::CGameHelperDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CGameHelperDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CGameHelperDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
// CGameHelperDlg message handlers
